...
extern unsigned int const C_icon_default_colors[];
extern unsigned char const C_icon_default_bitmap[];
#ifdef OS_IO_SEPROXYHAL
        #include "os_io_seproxyhal.h"
        extern const bagl_icon_details_t C_icon_default;
        #endif // GLYPH_icon_default_BPP
