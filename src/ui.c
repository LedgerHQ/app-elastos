...
UX_STEP_NOCB(ux_confirm_single_flow_3_step,
             bnnn,
             {"Destination Address", tx_desc[1][0], tx_desc[1][1], tx_desc[1][2]});
UX_STEP_NOCB(ux_confirm_single_flow_4_step, bnn, {"Change Amount", tx_desc[2][0], tx_desc[2][1]});
UX_STEP_NOCB(ux_confirm_single_flow_5_step,
             bnnn,
             {"Change Address", tx_desc[3][0], tx_desc[3][1], tx_desc[3][2]});
UX_STEP_NOCB(ux_confirm_single_flow_6_step, bnn, {"Fee Amount", tx_desc[4][0], tx_desc[4][1]});
UX_STEP_NOCB(ux_confirm_single_flow_7_step,
             bnnn,
             {"Fee Address", tx_desc[5][0], tx_desc[5][1], tx_desc[5][2]});
UX_STEP_VALID(ux_confirm_single_flow_8_step,
              pb,
...
UX_STEP_VALID(ux_confirm_single_flow_9_step,
              pb,
...
static const bagl_element_t bagl_ui_public_key_nanos_1[] = {
    ...
    /* right icon is a X */
    {
        {BAGL_ICON, 0x00, 113, 12, 7, 7, 0, 0, 0, 0xFFFFFF, 0x000000, 0, BAGL_GLYPH_ICON_CROSS},
        NULL,
        0,
        0,
        0,
...
static const bagl_element_t bagl_ui_top_sign_nanos[] = {
    ...
    /* top left bar */
    {
        {BAGL_RECTANGLE, 0x00, 3, 1, 12, 2, 0, 0, BAGL_FILL, 0xFFFFFF, 0x000000, 0, 0},
        NULL,
        0,
        0,
        0,
    ...
    /* top right bar */
    {
        {BAGL_RECTANGLE, 0x00, 113, 1, 12, 2, 0, 0, BAGL_FILL, 0xFFFFFF, 0x000000, 0, 0},
        NULL,
        0,
        0,
        0,
    ...
    {
        {BAGL_ICON, 0x00, 117, 13, 8, 6, 0, 0, 0, 0xFFFFFF, 0x000000, 0, BAGL_GLYPH_ICON_DOWN},
        NULL,
        0,
        0,
        0,
...
static const bagl_element_t bagl_ui_deny_nanos[] = {
    ...
    {
        {BAGL_ICON, 0x00, 117, 13, 7, 7, 0, 0, 0, 0xFFFFFF, 0x000000, 0, BAGL_GLYPH_ICON_DOWN},
        NULL,
        0,
        0,
        0,
